 ...
 * @author Duy.Tran
 */
@WebFilter(filterName = "LoginFilter", servletNames = {"ListAccountsServlet", "ListCategoryServlet","ListProductServlet"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD})
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if(action == null || action.equals(Action.HOME)) {
            ...
            chain.doFilter(wrappedRequest, wrappedResponse);
                 ...
                 request.getRequestDispatcher(Navigation.LOGIN_URL).forward(request, response);
            }
        } catch (Throwable t) {
