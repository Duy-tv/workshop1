...
public final class Login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <link rel=\"stylesheet\" href=\"styles/animations.css\">\n");
      out.write("    </head>\n");
      out.write("    <body class=\"flex-block items-center  min-h-screen bg-gray-100\">\n");
      out.write("        ");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("</html>\n");
      out.write("\n");
      out.write("        <form action=\"LoginServlet\" method=\"post\" class=\"bg-white p-6 rounded-lg shadow-md w-full max-w-sm h-full max-h-sm my-20 mx-auto fade-in\">\n");
      out.write("            <h2 class=\"text-2xl font-bold mb-4 text-center\">Login</h2>\n");
      out.write("\n");
      out.write("            <div class=\"mb-4\">\n");
      out.write("                <label for=\"txtaccount\" class=\"block text-gray-700\">Account</label>\n");
      out.write("                <input type=\"text\" id=\"txtaccount\" name=\"txtaccount\" placeholder=\"Enter Account\" required=\"\"\n");
      out.write("                       class=\"mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:ring-1 focus:border-indigo-500 sm:text-sm\" />\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <div class=\"mb-6\">\n");
      out.write("                <label for=\"txtpassword\" class=\"block text-gray-700\">Password</label>\n");
      out.write("                <input type=\"password\" id=\"txtpassword\" name=\"txtpassword\" placeholder=\"Enter password\" required=\"\"\n");
      out.write("                       class=\"mt-1 block w-full px-3 py-2 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:ring-1 focus:border-indigo-500 sm:text-sm\" />\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("            <button type=\"submit\" class=\"w-full py-2 px-4 bg-indigo-600 text-white font-bold rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50\" name=\"action\" value=\"");
      out.print( Action.LOGIN );
      out.write("\">Login</button>\n");
      out.write("            <p class=\"my-2 text-red-600\">");
