...
public final class Register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    </head>\n");
      out.write("    <body>\n");
      out.write("        <div class=\"bg-gray-100 flex items-center justify-center h-full w-screen\">\n");
      out.write("            <div class=\"bg-white p-8 rounded-lg shadow-lg w-full max-w-lg\">\n");
      out.write("                <h2 class=\"text-2xl font-bold mb-6 text-gray-800\">Add new account</h2>\n");
      out.write("                <form action=\"insertAccount\" method=\"post\">\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Account</label>\n");
      out.write("                        <input type=\"email\" name=\"account\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" placeholder=\"Enter email\" required>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Password</label>\n");
      out.write("                        <input type=\"password\" name=\"password\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" placeholder=\"Enter password\" required>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Last name</label>\n");
      out.write("                        <input type=\"text\" name=\"lastName\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" placeholder=\"Last name\" required>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">First name</label>\n");
      out.write("                        <input type=\"text\" name=\"firstName\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" placeholder=\"First name\" required>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Phone number</label>\n");
      out.write("                        <input type=\"text\" name=\"phone\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" placeholder=\"Phone number\" required>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Birth day</label>\n");
      out.write("                        <input type=\"date\" name=\"birthday\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" required>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Gender</label>\n");
      out.write("                        <div class=\"flex items-center\">\n");
      out.write("                            <label class=\"mr-4\">\n");
      out.write("                                <input type=\"radio\" name=\"gender\" value=\"Male\" class=\"mr-1\" required> Male\n");
      out.write("                            </label>\n");
      out.write("                            <label>\n");
      out.write("                                <input type=\"radio\" name=\"gender\" value=\"Female\" class=\"mr-1\" required> Female\n");
      out.write("                            </label>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700\">Role in system</label>\n");
      out.write("                        <select name=\"roleInSystem\" class=\"w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500\" required>\n");
      out.write("                            <option value=\"Administrator\">Administrator</option>\n");
      out.write("                            <option value=\"User\">User</option>\n");
      out.write("                            <!-- Add more roles as needed -->\n");
      out.write("                        </select>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"mb-4\">\n");
      out.write("                        <label class=\"block text-gray-700 flex items-center\">\n");
      out.write("                            <input type=\"checkbox\" name=\"isUse\" class=\"mr-2\"> Is active\n");
      out.write("                        </label>\n");
      out.write("                    </div>\n");
      out.write("                    <div class=\"text-center\">\n");
      out.write("                        <button type=\"submit\" class=\"bg-indigo-500 text-white px-[10vw] py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:bg-indigo-600\">Add</button>\n");
      out.write("                    </div>\n");
      out.write("                </form>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
